...
############################ HELPER FUNCTIONS ##################################
    ...
    def load(self):
        self.background = pygame.image.load(
            'D:\\vsC\\data_structure_lpu\\INT213-Python Programming\\Projects\\pacman-with-python\\maze.png')
        self.background = pygame.transform.scale(self.background, (MAZE_WIDTH, MAZE_HEIGHT))

        # Opening walls file
        # Creating walls list with co-ords of walls
        # stored as  a vector
        with open("D:\\vsC\\data_structure_lpu\\INT213-Python Programming\\Projects\\pacman-with-python\\walls.txt", 'r') as file:
